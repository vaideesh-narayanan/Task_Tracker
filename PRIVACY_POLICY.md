...
Task Tracker is built with a strict offline-first and privacy-focused architecture. 
All the data you enter into Task Tracker (including goals, pending work, completed tasks, and settings) is stored exclusively locally on your device. We do not collect, transmit, or store your personal data on any external servers.

## 2. Permissions

Task Tracker requires the following permissions to function as intended:
- **Notifications (`POST_NOTIFICATIONS`)**: This permission is required on modern Android devices to send local notifications related to your tasks. 

No other unnecessary permissions (such as location, contacts, or camera) are requested or required.
